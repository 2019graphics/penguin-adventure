function drawSeal(xOffset, yOffset, zOffset) {
    ...
    var headMaterial = new THREE.MeshLambertMaterial({ color: 0xD0CECE });//material, 16���� ��
    ...
    var bodyMaterial = new THREE.MeshLambertMaterial({ color: 0xD0CECE });//material, 16���� ��
    ...
    var tailMaterial = new THREE.MeshLambertMaterial({ color: 0xD0CECE });//material, 16���� ��
    ...
    var handMaterial = new THREE.MeshLambertMaterial({ color: 0xD0CECE });//material, 16���� ��
